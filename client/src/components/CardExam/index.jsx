...
const CardExam = ({ exam, handleOpenDrawerDetail, handleOpenModalEdit }) => {
      ...
      <Box w='100%'>
         ...
         >
            <Box
               ...
               onClick={() => handleOpenDrawerDetail(exam)}
               bg='white'
               borderRadius='lg'
               px='15px'
               py='10px'
            ...
            >
               ...
               <Box textAlign='left' flex='1'>
                  <Text fontSize={['md', 'lg', 'xl']}>
                     {exam?.title?.length > 45
                        ? `${exam?.title.substring(0, 45)}...`
                        : exam?.title}
                  </Text>
                  <Flex justifyContent='space-between'>
                     <Text color='textSecondary' fontSize={['sm', 'md', 'lg']}>
                        {new Date(exam?.createdAt).toLocaleDateString('id', {
                           weekday: 'long',
                           year: 'numeric',
                           month: '2-digit',
                           day: 'numeric',
                     ...
                     >
                        ...
                        <Text color='red' fontSize={['sm']}>
                           {new Date(exam?.due).toLocaleDateString('id', {
                              weekday: 'long',
                              year: 'numeric',
                              month: '2-digit',
                              day: 'numeric',
               ...
               <>
                  ...
                  >
                     <Button
                        variant='solid'
                        colorScheme='yellow'
                        onClick={() => handleOpenModalEdit(exam)}
                     >
                        <MdEdit size='24px' />
                     </Button>
               ...
               <DrawerBody>
                  ...
                  {exam.video && (
                     <VStack spacing={4} alignItems='flex-start' mt='20px'>
                        ...
                        <Box>
                           <ReactPlayer url={exam?.video} controls={true} />
                        </Box>
                     </VStack>
                  )}
                  ...
                  {exam.document && (
                     <VStack spacing={4} alignItems='flex-start' mt='20px'>
                        ...
                        <Link href={exam?.document} isExternal>
                           <Image
                              w='70px'
                              h='70px'
